...
namespace ProjetoEscola.API.Controllers
{
    ...
    {
        private readonly ITeacherSubjectService _teahcherSubjectService;

        public TeacherSubjectsController(ITeacherSubjectService teahcherSubjectService)
        {
        ...
        /// </summary>
        [HttpPost]
        public ActionResult CreateAsync([FromBody] TeachersSubjectsDTO teachersSubjectsDTO)
        {
            try
            {
        ...
        /// </summary>
        [HttpPut]
        public async Task<ActionResult> UpdateAsync(TeachersSubjectsDTO teachersSubjectsDTO)
        {
            try
            {
