...
namespace ProjetoEscola.API.Controllers
{
    ...
    {
        private readonly IProfessorService _teacherService;
        private readonly IProfessorDisciplinaService _teacherSubjectService;
        private readonly IUnitOfWork _unitOfWork;

        public ProfessorController(IProfessorService teacherService, IProfessorDisciplinaService teachersubjectService, IUnitOfWork unitOfWork)
        {
        ...
        /// </summary>
        [HttpPost]
        public ActionResult CreateAsync([FromBody] ProfessorDTO teachersDTO)
        {
            try
            {
        ...
        /// </summary>
        [HttpPut]
        public async Task<ActionResult> UpdateAsync(ProfessorDTO teachersDTO)
        {
            try
            {
