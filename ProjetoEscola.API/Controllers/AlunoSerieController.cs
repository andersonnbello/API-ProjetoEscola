...
namespace ProjetoEscola.API.Controllers
{
    ...
    [ApiController]
    public class AlunoSerieController : ControllerBase
    {
        private readonly IAlunoSerieService _studentSerieService;

        public AlunoSerieController(IAlunoSerieService studentSerieService)
        {
        ...
        /// </summary>
        [HttpPost]
        public ActionResult CreateAsync([FromBody] AlunoSerieDTO studentSerieDTO)
        {
            try
            {
        ...
        /// </summary>
        [HttpPut]
        public async Task<ActionResult> UpdateAsync(AlunoSerieDTO studentSerieDTO)
        {
            try
            {
