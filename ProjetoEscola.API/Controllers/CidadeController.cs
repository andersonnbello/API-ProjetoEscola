...
namespace ProjetoEscola.API.Controllers
{
    ...
    public class CidadeController : ControllerBase
    {
        ...
        public CidadeController(ICidadeService cityService)
        {
        ...
        /// </summary>
        [HttpPost]
        public ActionResult CreateAsync([FromBody] CidadeDTO cityDTO)
        {
            try
            {
        ...
        /// </summary>
        [HttpPut]
        public async Task<ActionResult> UpdateAsync(CidadeDTO cityDTO)
        {
            try
            {
