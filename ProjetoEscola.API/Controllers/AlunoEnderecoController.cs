...
namespace ProjetoEscola.API.Controllers
{
    ...
    [ApiController]
    public class AlunoEnderecoController : ControllerBase
    {
        private readonly IAlunoEnderecoService _studentsAddressService;

        public AlunoEnderecoController(IAlunoEnderecoService studentsAddressService)
        {
        ...
        /// </summary>
        [HttpPost]
        public ActionResult CreateAsync([FromBody] AlunoEnderecoDTO studentsAddressDTO)
        {
            try
            {
        ...
        /// </summary>
        [HttpPut]
        public async Task<ActionResult> UpdateAsync(AlunoEnderecoDTO studentsAddressDTO)
        {
            try
            {
